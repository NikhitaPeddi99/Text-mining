...
def process_text_to_tokens(corpus_tokens, stop_words, perform_Stemming, remove_stopwords):
    processed_tokens = []
    try:
        # performed stemming and without stop words removal
        if (perform_Stemming and not(remove_stopwords)):
        ...
        elif(perform_Stemming and remove_stopwords):
...
def preprocessing(raw_corpus, perform_stemming, remove_stopwords, global_stopwords):
    ...
    processed_tokens = process_text_to_tokens(corpus_tokens, stop_words, perform_stemming, remove_stopwords)
    # Step 6: Return the processed tokens for further analysis.
    return processed_tokens


def staging(folder_name, perform_stemming, remove_stopwords, global_stopwords):
    ...
    processed_tokens = preprocessing(raw_corpus, perform_stemming, remove_stopwords, global_stopwords)
...
[start_time, c1_stemmed_with_stop_words] = staging('Corpus1', True, False, [])
print(start_time)
...
[start_time, c1_stemmed_no_stop_words] = staging('Corpus1', True, True, [])
...
[start_time, c2_stemmed_with_stop_words] = staging('Corpus2', True, False, [])
print(start_time)
...
# With Stemming and with stop word removal.
[start_time, c2_stemmed_no_stop_words] = staging('Corpus2', True, True, [])
...
Please be aware that handling the provided excerpts might require more time due to the presence of 
...
# CORPUS 1
[start_time, c1_stemmed_with_stop_words] = staging('Corpus1', True, True, global_stopwords)
...
# CORPUS 2
[start_time, c2_stemmed_with_stop_words] = staging('Corpus2', True, True, global_stopwords)
